...
import com.springboot.food.entity.FoodEntity;
import com.springboot.food.io.FoodRequest;
import com.springboot.food.io.FoodResponse;
import com.springboot.food.repository.FoodRepository;
    ...
    public String uploadFile(MultipartFile file) {
        ...
        try{
            ...
            if (response.sdkHttpResponse().isSuccessful()){
                ...
                throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "File uplaod Failed");
            }
        }catch (IOException ex){
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "An error occured file uploading file");
        }
    }
